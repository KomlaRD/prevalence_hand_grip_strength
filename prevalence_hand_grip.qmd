...
report_df <- clean_data |>
  select(-c(if_yes, participant_id))
...
```{r export_clean_data}
# Export csv data
export(df, here("data", "hand_grip_dataset.csv"))

# Export excel data
# export(df, here("data", "hand_grip_dataset.xlsx"))

# Export spss data
# export(df, here("data", "hand_grip_dataset.sav"))
```
